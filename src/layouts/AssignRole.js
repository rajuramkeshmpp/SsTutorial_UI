    ...
    <div style={{maxWidth: '400px',margin: '40px auto',padding: '30px',backgroundColor: '#f2f5f9',borderRadius: '10px',boxShadow: '0 4px 10px rgba(0, 0, 0, 0.1)',fontFamily: 'Arial, sans-serif'}}>
      ...
      <form style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        <div>
          ...
          <select id="email" defaultValue=""style={{width: '100%', padding: '10px', borderRadius: '5px',  border: '1px solid #ccc' }} >
        ...
        <div>
          ...
          <select id="role" defaultValue="" style={{ width: '100%', padding: '10px', borderRadius: '5px', border: '1px solid #ccc' }} >
        ...
        <button type="button"style={{ padding: '12px',backgroundColor: '#4CAF50', color: 'white',fontWeight: 'bold',border: 'none',borderRadius: '5px',cursor: 'pointer', transition: 'background 0.3s ease' }}>
          Assign Role
        </button>
      </form>
    </div>
